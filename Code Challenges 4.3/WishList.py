...
def wish_list(wish_list, selected, cost, money):

   if selected in wish_list:# if the string is in the wish list
       if cost <= money:# if there is enough money
           return "You should buy a " + selected + "!"# return if everything returns True
       else:
           return "You should save up for a " + selected + "!"# return if string in list, but not enough money
   else:
       return "You probably don't want to buy a " + selected + "."# return if the string is not in list
