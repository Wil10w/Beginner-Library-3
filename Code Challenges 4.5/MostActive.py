...
def most_active(adict):
    #this could have been difficult, bit thanks to the simplicity of Python...
    #used max() and .get() to find the maximim integer in the dictionary and return its key
