...
def phonebook(names, numbers):
    # make an empty dict
    adict = {}
    # iterating over the range of one of the lists. so 0 1 2 3.
    for i in range(0, len(names)):
       # then using those numbers to add names[i] as the key and numbers[i] as the value
        adict[names[i]] = numbers[i]
