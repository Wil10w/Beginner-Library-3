...
# we are just getting the total population and the tital area...
def population_density(alistOfDict):
    #two empty variables to hold the totals
    pop = 0
    area = 0
    #looping over dicts in list
    for i in alistOfDict:
        #we add the key 'population and area from i
        pop += i['population']
        area += i['area']

    #then return pop divided by area
    return pop / area
