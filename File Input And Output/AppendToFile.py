...
def append_to_file(aFile, anInteger):
    output_file = open(aFile, 'a') #opens file with append mode
    print(str(anInteger), file=output_file)# using print instead of write and converting Int to Str
