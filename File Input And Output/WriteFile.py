...
def write_file(file, data):
    outout_file = open(file, "w")#  Open file to write mode
    outout_file.write(str(data) + '\n')#    write data to file by converting to a string first
    outout_file.close()# close the file when finished
